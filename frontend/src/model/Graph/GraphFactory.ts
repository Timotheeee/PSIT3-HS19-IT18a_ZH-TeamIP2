...
=======
>>>>>>> -fixed recommendation basic implementation and chaining
    ...
    for (let [key, value] of Object.entries(parsedObject)) {
      ...
      if(key === 'recommendations') {
        for (let [key2, value2] of Object.entries(value)) {
          if(key2 === 'scoreBased') {
            // @ts-ignore
            scoreBasedConfig = value2.data as ScoreBasedRecommendationConfigJSON[];
          }

          if(key2 === 'answerBased') {
            // @ts-ignore
            answerBasedConfig = value2.data as AnswerBasedRecommendationConfigJSON;
          }
        }
      }
    }
